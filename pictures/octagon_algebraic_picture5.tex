...
\draw[purple] (-1,0) arc [start angle=180, end angle=270, radius=1];
\draw[purple] (1,0) arc [start angle=360, end angle=270, radius=1];

\draw[cyan] (A) -- (B1);
\draw[cyan] (A) -- (0,2);
\draw[cyan,dotted] (0,2) -- (0,2.5);
\draw[cyan] (-1,0) arc [start angle=180, end angle=90, radius=1];
\draw[cyan] (1,0) arc [start angle=0, end angle=90, radius=1];
