...
\draw[purple] (0,-1) arc [start angle=270, end angle=360, radius=1];
\draw[purple] (0,1) arc [start angle=90, end angle=0, radius=1];

\draw[cyan] (A) -- (B1);
\draw[cyan] (A) -- (-2,0);
\draw[cyan,dotted] (-2,0) -- (-2.5,0);
\draw[cyan] (0,-1) arc [start angle=270, end angle=180, radius=1];
\draw[cyan] (0,1) arc [start angle=90, end angle=180, radius=1];
